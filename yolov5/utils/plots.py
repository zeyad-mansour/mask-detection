...
def plot_one_box(x, img, color=None, label=None, line_thickness=None, dist=None):
    ...
    if label:
        ...
        if dist is not None:
            cv2.putText(img, "{:.2f} m".format(dist), (c2[0], c2[1] - 5), 0, tl / 3, [225, 255, 255], thickness=tf,
